...
import com.jroid.bdchat.databinding.ActivitySettingsBinding;
...
public class Settings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(Settings.this, "Profile Updated", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Settings.this, "Please enter username and Status", Toast.LENGTH_SHORT).show();
                }
        }});
        ...
        binding.textView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Settings.this, "Invite a Friend", Toast.LENGTH_SHORT).show();
            }
        });
        binding.textView5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Settings.this, "Notification", Toast.LENGTH_SHORT).show();
            }
        });
